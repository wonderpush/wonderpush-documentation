...
{
    // Ask the user to opt in to push notification
    // Because you only have ONE chance for prompting the user, you should find a good time for that.
    // But you can still opt to ask right from the first time he starts your app, as shown here.
