...
[[guide-event-concepts]]
=== Concepts

WonderPush enables you to track business events that make sense for your
application, and use them to further <<guide-audience,segment your
audience>> using behavioral patterns.

An event is attached to an <<guide-installation,installation>>, itself
attached to a <<guide-user,user>>. This way, you can notify a user on
