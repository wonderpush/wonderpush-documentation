...
. Select the same App ID you are using for the current certificate and clcik +Continue+
...
. Click +Fichier / Export Items+ (you needn't to enter a password)
. Go then to https://dashboard.wonderpush.com[WonderPush] (+Settings / Keys+ section) and upload the .p12 file
