...
. Dans Apple Developer https://developer.apple.com/account/ios/certificate/certificateList.action[Certificates], choisissez la section +Certificates, Identifiers & Profiles+ et cliquez sur +Add a new certificate+ (Ajouter un nouveau certificat)
...
. Allez enfin sur https://dashboard.wonderpush.com[WonderPush] (onglet +Réglages / clés+) et uploader le fichier .p12
